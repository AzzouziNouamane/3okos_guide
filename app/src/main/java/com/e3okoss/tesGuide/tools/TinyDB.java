...
public class TinyDB {
    ...
    public ArrayList<Page4Model> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Page4Model> objects =  new ArrayList<Page4Model>();

    	for(String jObjString : objStrings){
            Page4Model value  = gson.fromJson(jObjString,  Page4Model.class);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Page4Model> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
